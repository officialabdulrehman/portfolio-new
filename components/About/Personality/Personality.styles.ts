...
export const PersonalityElement = styled.div`
  display: flex;
  flex-direction: row;
...
export const PersonalityLeftElement = styled.div`
  h4 {
    padding: 0 0 5px 0;
    margin-top: 1rem;
    font-weight: 400;
...
export const PersonalityLeftHeading = styled.div`
  h1 {
    padding: 0 0 15px 0;
...
export const PersonalityRightElement = styled.div`
  height: 480px;
  width: 400px;
